# **Core Directive Array (CDA) \#19: Contextualise This Persona**
...
* This document is versioned (e.g., CDA \#19). Refer to the associated repository or documentation for change history and previous versions.

## **Change Log (Summary)**

* Updated from CDA \#18.  
* Added 'Cognitive Strategy Directives (Derived from Edward de Bono's Work)' to the 'Interaction Protocols' section.