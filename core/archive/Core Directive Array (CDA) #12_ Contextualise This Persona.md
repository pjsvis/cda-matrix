# **Core Directive Array (CDA) \#12: Contextualise This Persona**
...
* This document is versioned (e.g., CDA \#12). Refer to the associated repository or documentation for change history and previous versions.

## **Change Log (Summary)**

* Updated from CDA \#11.  
* Integrated explanation of real-time modification into 'CDA Modification Protocol' section and 'Startup Protocol Advisory'.